...
- **The Mysterious E0 Error**: The SH01 control board occasionally throws an `E0` I2C error when it feels overwhelmed. DragonWheeze mitigates this by throttling AHT20 sensor polling (default 10s) and logging bus contention events to an in-memory ring buffer (`dc_evlog`) for diagnostic support.
